...
{
   private Circle1 circle1;// Data needed for each test case
...
/***Test0 - invalid radius less than 0***/
//
@Test
public void checkRadius(){
	try{
    Circle1 circle2 = new Circle1(1,2,-10); 
    }
    catch (Error e){
...
public void circlesDontIntersect()
{
   boolean b;
   System.out.println("Running test intersects.");
   Circle1 circle2 = new Circle1(10,15,3);
   b = circle1.intersects(circle2);
...
{
   boolean b;
   Circle1 circle2 = new Circle1(2,2,1);
   b = circle1.intersects(circle2);
   Assert.assertTrue(b==false);
}
/** 
