...
* @param radius is the radius, radius greater than or equal to 0
**/
...
center = new Point();
   ...
   //A circle has a radius less than zero.
   if(radius >= 0)
   {
	  this.radius = radius;   
   }
   ...
   {
       throw new java.lang.Error("ERROR: invalid radius");
   }   
}
...
{
   radius = radius * factor;//Changed + for *
   return radius;
}
